    ...
    return (
        <form className='pt-20 flex flex-col items-center gap-5' onSubmit={handleSubmit}>
            ...
            <div className='w-1/4'>
                ...
                <input id='pass' className='w-full text-sm border-violet-500 ml-2 rounded-lg p-2 border-2 mt-3' type="password" value={password} onChange={handlePasswordChange} />
            </div>
            <button className='mt-3 p-2 bg-fuchsia-300 border text-lg font-medium rounded-md text-slate-700'
                type="submit"
